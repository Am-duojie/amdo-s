...
from .views import (
    ...
    RecycledProductsView, VerifiedListingsView, UsersView, AuditLogsView, RolesView,
...
urlpatterns = [
    ...
    path('service/conversations', AdminServiceConversationsView.as_view()),
    path('service/messages', AdminServiceMessagesView.as_view()),
    path('service/messages/read', AdminServiceReadView.as_view()),
    path('service/token', AdminServiceTokenView.as_view()),
